  ...
  const photos = [
    {
      id: 1,
      url: Img1,
      title: 'Kissing on the cliff',
      description: 'The most magical place to kiss you while sitting on a cliff and just talking',
      date: 'July 7, 2025'
    },
    {
      id: 2,
      ...
      description: 'My most favourite photo of us walking towards the sunset holding hands. Looks like the end of a movie',
      date: 'July 7, 2025'
    },
    {
      id: 3,
      url: Img3,
      title: 'Love all the selfies',
      description: 'One of my favourite selfies of us together. You looook fucking pretty',
      date: 'July 7, 2025'
    },
